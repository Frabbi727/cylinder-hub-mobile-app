...
OverdueCustomer _$OverdueCustomerFromJson(Map<String, dynamic> json) =>
    OverdueCustomer(
      customerId: json['customer_id'] == null ? 0 : _toInt(json['customer_id']),
      name: json['name'] == null ? '' : _toString(json['name']),
      phone: _toStringNull(json['phone']),
      totalDue: json['total_due'] == null ? 0.0 : _toDouble(json['total_due']),
      oldestDueDate: json['oldest_due_date'] == null
          ? ''
          : _toString(json['oldest_due_date']),
      daysOverdue: json['days_overdue'] == null
          ? 0
          : _toInt(json['days_overdue']),
      unpaidSalesCount: json['unpaid_sales_count'] == null
          ? 0
          : _toInt(json['unpaid_sales_count']),
