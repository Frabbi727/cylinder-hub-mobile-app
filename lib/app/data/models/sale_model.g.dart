...
Sale _$SaleFromJson(Map<String, dynamic> json) => Sale(
  id: _toInt(json['id']),
  saleDate: json['sale_date'] == null ? '' : _toString(json['sale_date']),
...
SaleItem _$SaleItemFromJson(Map<String, dynamic> json) => SaleItem(
  ...
  unitPrice: json['unit_price'] == null ? 0.0 : _toDouble(json['unit_price']),
...
DueCollection _$DueCollectionFromJson(Map<String, dynamic> json) =>
    DueCollection(
      id: _toInt(json['id']),
      amount: json['amount'] == null ? 0.0 : _toDouble(json['amount']),
      collectionDate: json['collection_date'] == null
          ? ''
          : _toString(json['collection_date']),
